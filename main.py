...
from modules import garelly_functions  
from modules import builtins     
from modules import control_functions
from modules import user_defined_functions
...
mylist1.insert(1, ">> Custom equation")
mylist1.insert(2, ">> Quadratic equation")
mylist1.insert(3, ">> EMW eaquations")
mylist1.insert(4, ">> Exponential equation")
mylist1.insert(5, ">> Pulse plotting")
mylist1.insert(6, ">> Transfer function")
mylist1.insert(7, ">> Diode equation")
mylist1.insert(8, ">> Three phase function")
mylist1.insert(9, ">> Sine function")
mylist1.insert(10, ">> Cosine vs sine function")
mylist1.insert(11, ">> Cosine function")
...
mylist.insert(3, ">> Power Star-Delta")
mylist.insert(4, ">> Pulse generation")
mylist.insert(5, ">> Simple Palabola")
mylist.insert(6, ">> Time domain specifications")
# mylist.insert(7, ">> System stability")
mylist.insert(8, ">> Magnitude of Signal")
mylist.insert(9, ">> Sine wave")
mylist.insert(10,">> Cosine wave")
mylist.insert(11,">> Cosine Signal Animation")
mylist.insert(12,">> Sine Signal Animation")
mylist.insert(13,">> Sine-Cosine Signal Animation")
mylist.insert(14,">> Sine-Cosine Signal")
mylist.insert(15,">> Ohms Low")
mylist.insert(16,">> Three phase voltages")
mylist.insert(17,">> Three phase current")
mylist.insert(18,">> Three Phase Signal")
mylist.insert(19,">> Frequency Domain")
# mylist.insert(20,">> Step responce")
# mylist.insert(21,">> Impulse responce")
mylist.insert(22,">> Voice Signal")
mylist.insert(23,">> Sinc function")
mylist.insert(24,">> Distribution Function")
mylist.insert(25,">> Area under curve")
mylist.insert(26,">> Keiser Window")
mylist.insert(27,">> Furier Transform")
mylist.insert(28,">> Distrect Furier Transform")
...
##        tkMessageBox.showinfo( "Hello user", "Please select built in function you want")
    ...
    if b==">> Magnitude of Signal":
        builtins.magnitude_of_signal()

    if b==">> Cosine Signal Animation":
        builtins.cosine_animated()
    if b==">> Sine Signal Animation":
        builtins.sine_animated()
    if b==">> Sine-Cosine Signal Animation":
        builtins.sine_cos_animated()
    if b==">> Ohms Low":
        builtins.ohmslow()
    if b==">> Sine-Cosine Signal":
        builtins.sine_cosine()
    if b==">> Voice Signal":
        builtins.voice_signal()
    if b==">> Frequency Domain":
        builtins.frequesncy_domain()
    if b==">> Power Star-Delta":
        builtins.electric_power_star_delta()
    if b==">> Three Phase Signal":
        builtins.three_phase_wave()
    if b==">> Distribution Function":
        builtins.distrubution_function()
    if b==">> Simple Palabola":
        builtins.simple_palabola()
    if b==">> Keiser Window":
        builtins.kaiser_window()
    if b==">> Furier Transform":
        builtins.FT_rectangular()  
    if b==">> Distrect Furier Transform":
        builtins.DFT()  
...
def userSelection1():
    ...
    if bb==">> Custom equation":
        f2=Top_Levels_user_input.toplevelwindow0()
...
class Top_Levels_user_input:
    ...
    def toplevelwindow0():
        ...
        k.geometry("310x265+207+180")#setting the size of my App
        k.resizable(0,0) #disabling the maximize button
        k.title("Custom equation")

        #__________FUNCTION TO GET USER INPUT DATA_________
        def custom_equation():
            global typed_string
      
            typed_string = a_entryy.get()
            
            print("Typed "+ typed_string)
            
            # typed_string=float(typed_string)
            #### call the function to do the JOB
            #user_defined_functions.my_plot1(a,b,c,d)

        a_entryy=Entry(k)
        a_label=Label(k,text="Type equ ")
        a_label.place(x=10, y=65)     
        a_entryy.place(x=85, y=35, width=200, height=100)

        t=tkinter.Button(k, text="   Analyze    ",font="Times 10 italic bold",fg="black",bg="green", command=custom_equation)
        t.pack()
        t.place(x=100, y=235)
